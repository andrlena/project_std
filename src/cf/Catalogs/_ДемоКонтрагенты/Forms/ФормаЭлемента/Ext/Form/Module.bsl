...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппыДляРазмещения.Добавить(УправлениеСвойствами.НаборСвойствПоИмени("Справочник_ДемоКонтрагенты_Основное"),
		Элементы.ГруппаОсновное.Имя);
	...
	ПараметрыОтображенияМеток.ИмяЭлементаДляРазмещенияМеток = Элементы.ГруппаМетки.Имя;
	...
	РазмещеныНаФорме.Вставить("_ДемоАдресКонтрагента", Истина);
	РазмещеныНаФорме.Вставить("_ДемоEmailКонтрагента", Истина);
	РазмещеныНаФорме.Вставить("_ДемоSkypeКонтрагенты", Истина);
	РазмещеныНаФорме.Вставить("_ДемоТелефонКонтрагента", Истина);
	РазмещеныНаФорме.Вставить("_ДемоМессенджерыКонтрагента", Истина);
	РазмещеныНаФорме.Вставить("_ДемоЮридическийАдресКонтрагента", Истина);
	...
	ДополнительныеПараметрыКонтактнойИнформации.РазмещеныНаФорме = РазмещеныНаФорме;

	УправлениеКонтактнойИнформацией.ПриСозданииНаСервере(ЭтотОбъект, Объект,
		ДополнительныеПараметрыКонтактнойИнформации);
